    ...
    return(
        <>
            <div className="h-screen flex items-center justify-center text-center">
                <div>
                    <h1 className="text-gray-800 text-lg font-mono font-bold tracking-wide">UNDER CONSTRUCTION</h1> 
                    <p className="text-gray-500 text-xs mt-5 font-mono">This site is under maintenance sorry for inconvenience</p>
