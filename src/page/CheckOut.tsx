...
const CheckOut: React.FC = () => {
  ...
  const onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    axios({
      method: "post",
      url: "/.netlify/functions/index?name=checkOut&&component=transaction",
        ...
        <div className="md:flex md:justify-between">
          <div className="w-full mb-2">
            <form
              ...
              className="shadow py-6 px-6 md:mr-6"
            >
              <Back path="/cart" />
              ...
              <div className="text-right">
                <button className="border py-1 px-4 rounded bg-red-500 text-white hover:bg-red-400">
                  Checkout
                </button>
              </div>
            </form>
          ...
          <div className="md:w-1/2">
            <div className="shadow px-5 py-4">
              <div className="my-5 flex justify-between items-center">
                <div>
                  <span className="text-2xl block text-black">Your cart</span>
                </div>
                <div>
                  <span className="bg-gray-400 py-2 px-3 rounded-full text-white font-bold">
                    {pending.length}
                  </span>
                </div>
              </div>
                  ...
                  <div className="flex items-center justify-between overflow-auto">
                    ...
                    <div>
                      <span className="block text-sm">
                        ...
                        {(
                          items.Subtotal -
                          items.Subtotal * items.valueAddedTax
                        ).toLocaleString()}
                      </span>
                    </div>
                  </div>
              ...
              <div className="text-right flex items-center justify-between">
                ...
                <span className="block">₱{total.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
